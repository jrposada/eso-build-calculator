...
use crate::data::bonuses::{
    EMPOWER, MAJOR_BERSERK, MAJOR_BREACH, MAJOR_BRUTALITY, MAJOR_PROPHECY, MAJOR_SAVAGERY, MAJOR_SORCERY, MINOR_BERSERK, MINOR_VULNERABILITY,
};
use crate::domain::{
    BonusData, BonusSource, BonusTarget, BonusTrigger, BonusValue, ClassName, DamageFlags, DotDamage, ExecuteScaling, HitDamage, Resource, SkillDamage, SkillData, SkillLineName,
};
