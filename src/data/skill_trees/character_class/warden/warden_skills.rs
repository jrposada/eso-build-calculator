...
use crate::data::bonuses::{
    MAJOR_BREACH, MAJOR_BRUTALITY, MAJOR_PROPHECY, MAJOR_SAVAGERY, MAJOR_SORCERY, MINOR_BERSERK, MINOR_BREACH, MINOR_VULNERABILITY,
};
use crate::domain::{
...
pub static WARDEN_SKILLS: Lazy<Vec<SkillData>> = Lazy::new(|| {
    vec![
        ...
        .with_skill_id(86048)
        .with_bonuses(vec![MINOR_BERSERK.clone().with_trigger(BonusTrigger::AbilitySlotted)]),
        SkillData::new(
            "Blue Betty",
            "Betty Netch",
            ClassName::Warden,
